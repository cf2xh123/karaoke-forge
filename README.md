...
> 当前版本：`0.8.0`（Alpha）。建议先用一首 1～2 分钟的歌曲试跑并检查时间轴，再处理正式 MV。
...
- 可从 Vmoe 取得逐字特效 ASS，或读取 QQ 音乐/网易云公开歌词，再按演唱速度精修行级时间；
...
QQ 音乐/网易云链接或自己的歌词；如果 MV 已含完整音轨，可以不再单独上传音频。先点
“生成可校准 KTV 工程”，
...
- **制作卡拉 OK MV**：一次上传音频、MV 与本地/Vmoe/QQ 音乐/网易云歌词，先生成可校准工程，确认后再

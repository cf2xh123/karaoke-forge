...
> 当前版本：`0.10.0`（Alpha）。建议先用一首 1～2 分钟的歌曲试跑并检查时间轴，再处理正式作品。
...
- 没有 MV 时可使用本地或网易云/QQ 音乐专辑图，生成黑胶唱片机、封面光晕或频谱舞台，
  波形与频谱会跟随真实音频变化；
...
- **制作卡拉 OK MV**：一次上传音频、MV/专辑图片与本地/Vmoe/UtaTen/QQ 音乐/网易云
  歌词，先生成可校准工程，确认后再渲染最终视频；无 MV 时支持三种音频响应画面，也保留
  直接生成快捷入口；
